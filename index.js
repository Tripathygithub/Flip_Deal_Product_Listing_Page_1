...
function productSortedByPopularity(product1, product2) {
  return product2.rating - product1.rating;
}
app.get('/products/sort/popularity', (req, res) => {
  sortedProducts = products.slice();
  sortedProducts.sort(productSortedByPopularity);
  res.json(sortedProducts);
});

function sortedByHightoLowPrice(product1, product2) {
  return product2.price - product1.price;
}
app.get('/products/sort/price-high-to-low', (req, res) => {
  let sortedProducts = products.slice();
  sortedProducts.sort(sortedByHightoLowPrice);
  res.json(sortedProducts);
});

function sortedByLowtoHighPrice(product1, product2) {
  return product1.price - product2.price;
}
app.get('/products/sort/price-low-to-high', (req, res) => {
  let sortedProducts = products.slice();
  sortedProducts.sort(sortedByLowtoHighPrice);
  res.json(sortedProducts);
});
